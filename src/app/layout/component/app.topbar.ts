...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, TieredMenu, ButtonModule],
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <p-button severity="info" type="button"
                    (click)="menu.toggle($event)" icon="pi pi-user" [rounded]="true"
                    [text]="true"></p-button>
                    <p-tiered-menu #menu [model]="items" [popup]="true"></p-tiered-menu>
                </div>
            </div>
        </div>
    </div>`
